...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://jobfit-analyzer.onrendehttps://jobfit-analyzer-3u46.onrender.comr.com/upload', formData)
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      formData.append('role', role)
      const response = await axios.post('https://jobfit-analyzer.onrendehttps://jobfit-analyzer-3u46.onrender.comr.com/download', formData, { responseType: 'blob' })
